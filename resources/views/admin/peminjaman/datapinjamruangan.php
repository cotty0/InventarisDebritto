<div class="main-panel">
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><?php echo $pinjamruangan['jam_mulai'] ?></td>
												<td><?php echo $pinjamruangan['jam_selesai'] ?></td>
												<td>
												...
												<td>
													<?php if ($pinjamruangan['status'] == 'menunggu') { ?>
														...
														<a href="#modalApprovePinjamRuangan<?php echo $pinjamruangan['id'] ?>" data-toggle="modal" title="Batal Pinjam" class="btn btn-xs btn-success"><i 
	...
	<center>
		<h6><b>&copy; Copyright@sanatadharma</b></h6>
	</center>
</div>
