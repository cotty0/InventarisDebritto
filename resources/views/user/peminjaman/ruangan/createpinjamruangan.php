<div class="main-panel">
						...
						<form method="POST" action="" enctype="multipart/form-data">
							<div class="card-body">
								<div class="form-group">
									...
									<select class="form-control" id="id_ruangan" onchange="changeValue(this.value)" name="id_ruangan" required="">
						...
						<div class="card">
							...
							<form method="POST" action="" enctype="multipart/form-data">
								<div class="card-body">
									...
									<div class="form-group">
										<label>Jam Mulai Pinjam</label>
										<input type="time" name="tgl_mulai" class="form-control">
									</div>

									<div class="form-group">
										<label>Jam Selesai Pinjam</label>
	...
	<script type="text/javascript">
		...
		function changeValue(id_ruangan) {
	...
	//menghitung sisa stok
		...
		mysqli_query($conn, "INSERT into pinjamruangan values ('$id','$id_ruangan','$id_user','$tgl_mulai','$tgl_selesai','$jam_mulai','$jam_selesai','$status')");
