<div class="main-panel">
												...
												<tr>
													...
													<td>
														...
														<?php }elseif($pinjamruangan['status'] == 'approve') { ?>
															<a href="?view=detailpinjamruangan&id=<?php echo $pinjamruangan['id'] ?>" title="Detail" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
															<a href="#modalKembalikanPinjamRuangan<?php echo $pinjamruangan['id'] ?>" data-toggle="modal" title="Kembalikan" class="btn btn-xs btn-danger"><i 
															class="fa fa-trash"></i> Kembalikan</a>
														<?php }else { ?>
															<a href="?view=detailpinjamruangan&id=<?php echo $pinjamruangan['id'] ?>" title="Detail" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
															<div class="badge badge-success"><?php echo $pinjamruangan['status'] ?></div>
														<?php } ?>
	...
	<center><h6><b>&copy; Copyright@sanatadharma</b></h6></center>
</div>
